  ...
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
    ...
    if (!hasCal) {
      if (isIE || isOpera6) {
        ...
        calWin=window.open("","cal","toolbar=0,width="+calWidth+",titlebar=0,height="+calHeight+",screenx="+(winX+calOffsetX)+",screeny="+(winY+calOffsetY));
      }
    }
...
//user Registration
//function addCalendar(name, title, field, form) {
//addCalendar("dob", "Select Date", "dob", "form1");
addCalendar("start_date", "Select Date", "start_date", "frm");
addCalendar("first_review_date", "Select Date", "first_review_date", "frm");
addCalendar("second_review_date", "Select Date", "second_review_date", "frm");
addCalendar("submission_date", "Select Date", "submission_date", "frm");
