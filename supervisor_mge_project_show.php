...
if(isset($_GET['project_id']))
{
	...
	$sql = 'SELECT sp.name sp_name, st.name st_name, pj.*  ' . 
		...
		'WHERE project_id = ' . $_GET['project_id'] . ' AND pj.supervisor_id = ' . $_SESSION['supervisor_id'] . ';'; 
...
<tr><td align="center"> <input type="button" value="Back" onclick="location.href = 'supervisor_mge_project_main.php';"/></td><td align="center" />&nbsp;</td></tr>
</table>
